...
namespace XLite\Module\MultiSafepay\Sofort\Model\Payment\Processor;
...
class Sofort extends \XLite\Model\Payment\Base\WebBased {
    ...
    public function getSettingsWidget() {
        return 'modules/MultiSafepay/Sofort/config.tpl';
    }
    ...
    public function processReturn(\XLite\Model\Payment\Transaction $transaction) {
        ...
        if (\XLite\Core\Request::getInstance()->transactionid) {
            ...
            $settings = $this->getSofortPaymentSettings();
     ...
     * @return array
     */
    public function getSofortPaymentSettings() {
        $result = array();
    ...
    protected function getSetting($name) {
        ...
        if (is_null($result)) {
            $method = \XLite\Core\Database::getRepo('XLite\Model\Payment\Method')->findOneBy(array('service_name' => 'MultiSafepay Sofort'));
    ...
    protected function getFormURL() {
        return \XLite\Core\Converter::buildURL('sofort', 'transaction');
    }
