...
namespace XLite\Module\MultiSafepay\Maestro\Model\Payment\Processor;

class Maestro extends \XLite\Model\Payment\Base\WebBased {
    ...
    public function getSettingsWidget() {
        return 'modules/MultiSafepay/Maestro/config.tpl';
    }
    ...
    public function processReturn(\XLite\Model\Payment\Transaction $transaction) {
        ...
        if (\XLite\Core\Request::getInstance()->transactionid) {
            ...
            $settings = $this->getMaestroPaymentSettings();
    ...
    public function doTransactionRequest($issuerId, $transid) {
        //if ($issuerId) {
            ...
            if ($this->transaction) {
                ...
                $msp->transaction['gateway'] = 'MAESTRO';
     ...
     * @return array
     */
    public function getMaestroPaymentSettings() {
        $result = array();
    ...
    protected function getSetting($name) {
        ...
        if (is_null($result)) {
            $method = \XLite\Core\Database::getRepo('XLite\Model\Payment\Method')->findOneBy(array('service_name' => 'MultiSafepay Maestro'));
    ...
    protected function getFormURL() {
        return \XLite\Core\Converter::buildURL('maestro', 'transaction');
    }
