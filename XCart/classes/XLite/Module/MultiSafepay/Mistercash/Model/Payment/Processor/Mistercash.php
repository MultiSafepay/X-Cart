...
namespace XLite\Module\MultiSafepay\Mistercash\Model\Payment\Processor;

class Mistercash extends \XLite\Model\Payment\Base\WebBased {
    ...
    public function getSettingsWidget() {
        return 'modules/MultiSafepay/Mistercash/config.tpl';
    }
    ...
    public function processReturn(\XLite\Model\Payment\Transaction $transaction) {
        ...
        if (\XLite\Core\Request::getInstance()->transactionid) {
            ...
            $settings = $this->getMistercashPaymentSettings();
     ...
     * @return array
     */
    public function getMistercashPaymentSettings() {
        $result = array();
    ...
    protected function getSetting($name) {
        ...
        if (is_null($result)) {
            $method = \XLite\Core\Database::getRepo('XLite\Model\Payment\Method')->findOneBy(array('service_name' => 'MultiSafepay Mistercash'));
    ...
    protected function getFormURL() {
        return \XLite\Core\Converter::buildURL('mistercash', 'transaction');
    }
