...
namespace XLite\Module\MultiSafepay\Mistercash\Controller\Customer;

class Mistercash extends \XLite\Controller\Customer\ACustomer
{
    /**
     *
     * @return void
    ...
    protected function doActionTransaction()
    {
        try {
            ...
            $processor = new \XLite\Module\MultiSafepay\Mistercash\Model\Payment\Processor\Mistercash();
