...
namespace XLite\Module\MultiSafepay\Babygiftcard\Model\Payment\Processor;

class Babygiftcard extends \XLite\Model\Payment\Base\WebBased {
    ...
    public function getSettingsWidget() {
        return 'modules/MultiSafepay/Babygiftcard/config.tpl';
    }
    ...
    public function processReturn(\XLite\Model\Payment\Transaction $transaction) {
        ...
        if (\XLite\Core\Request::getInstance()->transactionid) {
            ...
            $settings = $this->getBabygiftcardPaymentSettings();
    ...
    public function doTransactionRequest($issuerId, $transid) {
        //if ($issuerId) {
            ...
            if ($this->transaction) {
                ...
                $msp->transaction['gateway'] = 'BABYGIFTCARD';
     ...
     * @return array
     */
    public function getBabygiftcardPaymentSettings() {
        $result = array();
    ...
    protected function getSetting($name) {
        ...
        if (is_null($result)) {
            $method = \XLite\Core\Database::getRepo('XLite\Model\Payment\Method')->findOneBy(array('service_name' => 'MultiSafepay Baby Giftcard'));
    ...
    protected function getFormURL() {
        return \XLite\Core\Converter::buildURL('babygiftcard', 'transaction');
    }
