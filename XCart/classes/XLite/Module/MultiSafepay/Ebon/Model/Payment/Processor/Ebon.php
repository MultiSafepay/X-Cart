...
namespace XLite\Module\MultiSafepay\Ebon\Model\Payment\Processor;

class Ebon extends \XLite\Model\Payment\Base\WebBased {
    ...
    public function getSettingsWidget() {
        return 'modules/MultiSafepay/Ebon/config.tpl';
    }
    ...
    public function processReturn(\XLite\Model\Payment\Transaction $transaction) {
        ...
        if (\XLite\Core\Request::getInstance()->transactionid) {
            ...
            $settings = $this->getEbonPaymentSettings();
     ...
     * @return array
     */
    public function getEbonPaymentSettings() {
        $result = array();
    ...
    protected function getSetting($name) {
        ...
        if (is_null($result)) {
            $method = \XLite\Core\Database::getRepo('XLite\Model\Payment\Method')->findOneBy(array('service_name' => 'MultiSafepay E-bon'));
    ...
    protected function getFormURL() {
        return \XLite\Core\Converter::buildURL('ebon', 'transaction');
    }
