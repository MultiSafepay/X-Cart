...
namespace XLite\Module\MultiSafepay\Fashioncheque\Model\Payment\Processor;

class Fashioncheque extends \XLite\Model\Payment\Base\WebBased {
    ...
    public function getSettingsWidget() {
        return 'modules/MultiSafepay/Fashioncheque/config.tpl';
    }
    ...
    public function processReturn(\XLite\Model\Payment\Transaction $transaction) {
        ...
        $processor->settings = 'MultiSafepay Fashioncheque';
    ...
    public function doTransactionRequest($issuerId, $transid) {
        $processor = new \XLite\Module\MultiSafepay\Ideal\Model\Payment\Processor\Ideal();
        $processor->doTransactionRequest('', $transid, 'MultiSafepay Fashioncheque', 'FASHIONCHEQUE');
    }
    ...
    protected function getFormURL() {
        return \XLite\Core\Converter::buildURL('fashioncheque', 'transaction');
    }
    ...
    public function getIconPath(\XLite\Model\Order $order, \XLite\Model\Payment\Method $method) {
        $processor = new \XLite\Module\MultiSafepay\Ideal\Model\Payment\Processor\Ideal();
        $processor->gateway = 'Fashioncheque';
        $processor->icon = 'msp_fashioncheque.png';
