...
namespace XLite\Module\MultiSafepay\Parfum\Model\Payment\Processor;

class Parfum extends \XLite\Model\Payment\Base\WebBased {
    ...
    public function getSettingsWidget() {
        return 'modules/MultiSafepay/Parfum/config.tpl';
    }
    ...
    public function processReturn(\XLite\Model\Payment\Transaction $transaction) {
        ...
        $processor->settings = 'MultiSafepay Parfum Cadeaukaart';
    ...
    public function doTransactionRequest($issuerId, $transid) {
        $processor = new \XLite\Module\MultiSafepay\Ideal\Model\Payment\Processor\Ideal();
        $processor->doTransactionRequest('', $transid, 'MultiSafepay Parfum Cadeaukaart', 'PARFUMCADEAUKAART');
    }
    ...
    protected function getFormURL() {
        return \XLite\Core\Converter::buildURL('parfum', 'transaction');
    }
    ...
    public function getIconPath(\XLite\Model\Order $order, \XLite\Model\Payment\Method $method) {
        $processor = new \XLite\Module\MultiSafepay\Ideal\Model\Payment\Processor\Ideal();
        $processor->gateway = 'Parfum';
        $processor->icon = 'msp_parfumcadeaukaart.png';
