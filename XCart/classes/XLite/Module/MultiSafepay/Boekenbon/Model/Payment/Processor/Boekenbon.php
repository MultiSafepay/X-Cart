...
namespace XLite\Module\MultiSafepay\Boekenbon\Model\Payment\Processor;

class Boekenbon extends \XLite\Model\Payment\Base\WebBased {
    ...
    public function getSettingsWidget() {
        return 'modules/MultiSafepay/Boekenbon/config.tpl';
    }
    ...
    public function processReturn(\XLite\Model\Payment\Transaction $transaction) {
        ...
        if (\XLite\Core\Request::getInstance()->transactionid) {
            ...
            $settings = $this->getBoekenbonPaymentSettings();
    ...
    public function doTransactionRequest($issuerId, $transid) {
        //if ($issuerId) {
            ...
            if ($this->transaction) {
                ...
                $msp->transaction['gateway'] = 'BOEKENBON';
     ...
     * @return array
     */
    public function getBoekenbonPaymentSettings() {
        $result = array();
    ...
    protected function getSetting($name) {
        ...
        if (is_null($result)) {
            $method = \XLite\Core\Database::getRepo('XLite\Model\Payment\Method')->findOneBy(array('service_name' => 'MultiSafepay Boekenbon'));
    ...
    protected function getFormURL() {
        return \XLite\Core\Converter::buildURL('boekenbon', 'transaction');
    }
