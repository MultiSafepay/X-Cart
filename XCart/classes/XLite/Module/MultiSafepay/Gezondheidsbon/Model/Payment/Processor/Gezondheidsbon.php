...
namespace XLite\Module\MultiSafepay\Gezondheidsbon\Model\Payment\Processor;

class Gezondheidsbon extends \XLite\Model\Payment\Base\WebBased {
    ...
    public function getSettingsWidget() {
        return 'modules/MultiSafepay/Gezondheidsbon/config.tpl';
    }
    ...
    public function processReturn(\XLite\Model\Payment\Transaction $transaction) {
        ...
        $processor->settings = 'MultiSafepay Gezondheidsbon';
    ...
    public function doTransactionRequest($issuerId, $transid) {
        $processor = new \XLite\Module\MultiSafepay\Ideal\Model\Payment\Processor\Ideal();
        $processor->doTransactionRequest('', $transid, 'MultiSafepay Gezondheidsbon', 'GEZONDHEIDSBON');
    }
    ...
    protected function getFormURL() {
        return \XLite\Core\Converter::buildURL('gezondheidsbon', 'transaction');
    }
    ...
    public function getIconPath(\XLite\Model\Order $order, \XLite\Model\Payment\Method $method) {
        $processor = new \XLite\Module\MultiSafepay\Ideal\Model\Payment\Processor\Ideal();
        $processor->gateway = 'Gezondheidsbon';
        $processor->icon = 'msp_gezondheidsbon.png';
