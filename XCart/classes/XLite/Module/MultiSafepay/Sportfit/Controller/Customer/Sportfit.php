...
namespace XLite\Module\MultiSafepay\Sportfit\Controller\Customer;

class Sportfit extends \XLite\Controller\Customer\ACustomer
{
    /**
     *
     * @return void
    ...
    protected function doActionTransaction()
    {
        try {
            ...
            $processor = new \XLite\Module\MultiSafepay\Sportfit\Model\Payment\Processor\Sportfit();
