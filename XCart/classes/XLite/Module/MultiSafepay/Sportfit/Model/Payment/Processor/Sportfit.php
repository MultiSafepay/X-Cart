...
namespace XLite\Module\MultiSafepay\Sportfit\Model\Payment\Processor;

class Sportfit extends \XLite\Model\Payment\Base\WebBased {
    ...
    public function getSettingsWidget() {
        return 'modules/MultiSafepay/Sportfit/config.tpl';
    }
    ...
    public function processReturn(\XLite\Model\Payment\Transaction $transaction) {
        ...
        $processor->settings = 'MultiSafepay Sportfit';
    ...
    public function doTransactionRequest($issuerId, $transid) {
        $processor = new \XLite\Module\MultiSafepay\Ideal\Model\Payment\Processor\Ideal();
        $processor->doTransactionRequest('', $transid, 'MultiSafepay Sportfit', 'SPORTFIT');
    }
    ...
    protected function getFormURL() {
        return \XLite\Core\Converter::buildURL('sportfit', 'transaction');
    }
    ...
    public function getIconPath(\XLite\Model\Order $order, \XLite\Model\Payment\Method $method) {
        $processor = new \XLite\Module\MultiSafepay\Ideal\Model\Payment\Processor\Ideal();
        $processor->gateway = 'Sportfit';
        $processor->icon = 'msp_sportfit.png';
