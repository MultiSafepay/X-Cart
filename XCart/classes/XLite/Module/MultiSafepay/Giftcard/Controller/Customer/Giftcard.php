...
namespace XLite\Module\MultiSafepay\Giftcard\Controller\Customer;

class Giftcard extends \XLite\Controller\Customer\ACustomer
{
    /**
     *
     * @return void
    ...
    protected function doActionTransaction()
    {
        try {
            ...
            $processor = new \XLite\Module\MultiSafepay\Giftcard\Model\Payment\Processor\Giftcard();
