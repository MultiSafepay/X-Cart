...
namespace XLite\Module\MultiSafepay\Mastercard\Model\Payment\Processor;

class Mastercard extends \XLite\Model\Payment\Base\WebBased {
    ...
    public function getSettingsWidget() {
        return 'modules/MultiSafepay/Mastercard/config.tpl';
    }
    ...
    public function processReturn(\XLite\Model\Payment\Transaction $transaction) {
        ...
        if (\XLite\Core\Request::getInstance()->transactionid) {
            ...
            $settings = $this->getMastercardPaymentSettings();
    ...
    public function doTransactionRequest($issuerId, $transid) {
        //if ($issuerId) {
            ...
            if ($this->transaction) {
                ...
                $msp->transaction['gateway'] = 'MASTERCARD';
     ...
     * @return array
     */
    public function getMastercardPaymentSettings() {
        $result = array();
    ...
    protected function getSetting($name) {
        ...
        if (is_null($result)) {
            $method = \XLite\Core\Database::getRepo('XLite\Model\Payment\Method')->findOneBy(array('service_name' => 'MultiSafepay Mastercard'));
    ...
    protected function getFormURL() {
        return \XLite\Core\Converter::buildURL('mastercard', 'transaction');
    }
