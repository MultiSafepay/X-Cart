...
class Erotiekbon extends \XLite\Model\Payment\Base\WebBased {
    ...
    public function processReturn(\XLite\Model\Payment\Transaction $transaction) {
        ...
        $processor->settings = 'MultiSafepay Nationale Erotiekbon';
    ...
    public function doTransactionRequest($issuerId, $transid) {
        $processor = new \XLite\Module\MultiSafepay\Ideal\Model\Payment\Processor\Ideal();
        $processor->doTransactionRequest('', $transid, 'MultiSafepay Nationale Erotiekbon', 'EROTIEKBON');
    }
    ...
    public function getIconPath(\XLite\Model\Order $order, \XLite\Model\Payment\Method $method) {
        $processor = new \XLite\Module\MultiSafepay\Ideal\Model\Payment\Processor\Ideal();
        $processor->gateway = 'Erotiekbon';
        $processor->icon = 'msp_erotiekbon.png';
