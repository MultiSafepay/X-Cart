...
namespace XLite\Module\MultiSafepay\Erotiekbon\Model\Payment\Processor;

class Erotiekbon extends \XLite\Model\Payment\Base\WebBased {
    ...
    public function getSettingsWidget() {
        return 'modules/MultiSafepay/Erotiekbon/config.tpl';
    }
    ...
    public function processReturn(\XLite\Model\Payment\Transaction $transaction) {
        ...
        if (\XLite\Core\Request::getInstance()->transactionid) {
            ...
            $settings = $this->getErotiekbonPaymentSettings();
    ...
    public function doTransactionRequest($issuerId, $transid) {
        //if ($issuerId) {
            ...
            if ($this->transaction) {
                ...
                $msp->transaction['gateway'] = 'EROTIEKBON';
     ...
     * @return array
     */
    public function getErotiekbonPaymentSettings() {
        $result = array();
    ...
    protected function getSetting($name) {
        ...
        if (is_null($result)) {
            $method = \XLite\Core\Database::getRepo('XLite\Model\Payment\Method')->findOneBy(array('service_name' => 'MultiSafepay Nationale Erotiekbon'));
    ...
    protected function getFormURL() {
        return \XLite\Core\Converter::buildURL('erotiekbon', 'transaction');
    }
