...
namespace XLite\Module\MultiSafepay\Paypal\Model\Payment\Processor;

class Paypal extends \XLite\Model\Payment\Base\WebBased {
    ...
    public function getSettingsWidget() {
        return 'modules/MultiSafepay/Paypal/config.tpl';
    }
    ...
    public function processReturn(\XLite\Model\Payment\Transaction $transaction) {
        ...
        if (\XLite\Core\Request::getInstance()->transactionid) {
            ...
            $settings = $this->getPaypalPaymentSettings();
    ...
    public function doTransactionRequest($issuerId, $transid) {
        //if ($issuerId) {
            ...
            if ($this->transaction) {
                ...
                $msp->transaction['gateway'] = 'PAYPAL';
     ...
     * @return array
     */
    public function getPaypalPaymentSettings() {
        $result = array();
    ...
    protected function getSetting($name) {
        ...
        if (is_null($result)) {
            $method = \XLite\Core\Database::getRepo('XLite\Model\Payment\Method')->findOneBy(array('service_name' => 'MultiSafepay Paypal'));
    ...
    protected function getFormURL() {
        return \XLite\Core\Converter::buildURL('paypal', 'transaction');
    }
    ...
    public function getIconPath(\XLite\Model\Order $order, \XLite\Model\Payment\Method $method) {
        ...
        $processor->gateway = 'Paypal';
        $processor->icon = 'msp_paypal.png';
