...
namespace XLite\Module\MultiSafepay\Amex\Model\Payment\Processor;

class Amex extends \XLite\Model\Payment\Base\WebBased {
    ...
    public function getSettingsWidget() {
        return 'modules/MultiSafepay/Amex/config.tpl';
    }
    ...
    public function processReturn(\XLite\Model\Payment\Transaction $transaction) {
        ...
        if (\XLite\Core\Request::getInstance()->transactionid) {
            ...
            $settings = $this->getAmexPaymentSettings();
     ...
     * @return array
     */
    public function getAmexPaymentSettings() {
        $result = array();
    ...
    protected function getSetting($name) {
        ...
        if (is_null($result)) {
            $method = \XLite\Core\Database::getRepo('XLite\Model\Payment\Method')->findOneBy(array('service_name' => 'MultiSafepay American Express'));
    ...
    protected function getFormURL() {
        return \XLite\Core\Converter::buildURL('amex', 'transaction');
    }
