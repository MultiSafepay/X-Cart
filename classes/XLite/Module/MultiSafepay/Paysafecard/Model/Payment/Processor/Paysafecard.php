...
namespace XLite\Module\MultiSafepay\Paysafecard\Model\Payment\Processor;

class Paysafecard extends \XLite\Model\Payment\Base\WebBased
{
    ...
    {
        return 'modules/MultiSafepay/Paysafecard/config.twig';
    }
    ...
    {
        $processor = new \XLite\Module\MultiSafepay\Connect\Model\Payment\Processor\Connect();
        $processor->startTransaction('', $transid, 'MultiSafepay Connect', 'PSAFECARD');
    }
    ...
    {
        return \XLite\Core\Converter::buildURL('paysafecard', 'transaction');
    }
    ...
    {
        $processor = new \XLite\Module\MultiSafepay\Connect\Model\Payment\Processor\Connect();
        $processor->gateway = 'Paysafecard';
        $processor->icon = 'msp_paysafecard.png';
