...
namespace XLite\Module\MultiSafepay\Connect\Controller\Customer;

class Connect extends \XLite\Controller\Customer\ACustomer
{
    ...
    protected function doActionTransaction()
    {
        try {
            ...
            $processor->startTransaction('', \XLite\Core\Request::getInstance()->transid);
        } catch (\Exception $e) {
