...
namespace XLite\Module\MultiSafepay\Winkelcheque\Model\Payment\Processor;

class Winkelcheque extends \XLite\Model\Payment\Base\WebBased
{
    ...
    {
        return 'modules/MultiSafepay/Winkelcheque/config.twig';
    }
    ...
    {
        $processor = new \XLite\Module\MultiSafepay\Connect\Model\Payment\Processor\Connect();
        $processor->startTransaction('', $transid, 'MultiSafepay Connect', 'WINKELCHEQUE');
    }
    ...
    {
        return \XLite\Core\Converter::buildURL('winkelcheque', 'transaction');
    }
    ...
    {
        $processor = new \XLite\Module\MultiSafepay\Connect\Model\Payment\Processor\Connect();
        $processor->gateway = 'Winkelcheque';
        $processor->icon = 'msp_winkelcheque.png';
