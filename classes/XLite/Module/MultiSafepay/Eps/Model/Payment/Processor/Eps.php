...
namespace XLite\Module\MultiSafepay\Eps\Model\Payment\Processor;

class Eps extends \XLite\Model\Payment\Base\WebBased
{
    ...
    {
        return 'modules/MultiSafepay/Eps/config.twig';
    }
    ...
    {
        $processor = new \XLite\Module\MultiSafepay\Connect\Model\Payment\Processor\Connect();
        $processor->startTransaction('', $transid, 'MultiSafepay Connect', 'EPS');
    }
    ...
    {
        return \XLite\Core\Converter::buildURL('eps', 'transaction');
    }
    ...
    {
        $processor = new \XLite\Module\MultiSafepay\Connect\Model\Payment\Processor\Connect();
        $processor->gateway = 'Eps';
        $processor->icon = 'msp_eps.png';
