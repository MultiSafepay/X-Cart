...
namespace XLite\Module\MultiSafepay\Fashiongiftcard\Model\Payment\Processor;

class Fashiongiftcard extends \XLite\Model\Payment\Base\WebBased
{
    ...
    {
        return 'modules/MultiSafepay/Fashiongiftcard/config.twig';
    }
    ...
    {
        $processor = new \XLite\Module\MultiSafepay\Connect\Model\Payment\Processor\Connect();
        $processor->startTransaction('', $transid, 'MultiSafepay Connect', 'FASHIONGIFTCARD');
    }
    ...
    {
        return \XLite\Core\Converter::buildURL('fashiongiftcard', 'transaction');
    }
    ...
    {
        $processor = new \XLite\Module\MultiSafepay\Connect\Model\Payment\Processor\Connect();
        $processor->gateway = 'Fashiongiftcard';
        $processor->icon = 'msp_fashiongiftcard.png';
