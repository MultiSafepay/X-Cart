...
namespace XLite\Module\MultiSafepay\Trustpay\Model\Payment\Processor;

class Trustpay extends \XLite\Model\Payment\Base\WebBased
{
    ...
    {
        return 'modules/MultiSafepay/Trustpay/config.twig';
    }
    ...
    {
        $processor = new \XLite\Module\MultiSafepay\Connect\Model\Payment\Processor\Connect();
        $processor->startTransaction('', $transid, 'MultiSafepay Connect', 'TRUSTPAY');
    }
    ...
    {
        return \XLite\Core\Converter::buildURL('trustpay', 'transaction');
    }
    ...
    {
        $processor = new \XLite\Module\MultiSafepay\Connect\Model\Payment\Processor\Connect();
        $processor->gateway = 'Trustpay';
        $processor->icon = 'msp_trustpay.png';
