...
namespace XLite\Module\MultiSafepay\Kelly\Model\Payment\Processor;

class Kelly extends \XLite\Model\Payment\Base\WebBased
{
    ...
    {
        return 'modules/MultiSafepay/Kelly/config.twig';
    }
    ...
    {
        $processor = new \XLite\Module\MultiSafepay\Connect\Model\Payment\Processor\Connect();
        $processor->startTransaction('', $transid, 'MultiSafepay Connect', 'KELLYGIFTCARD');
    }
    ...
    {
        return \XLite\Core\Converter::buildURL('kelly', 'transaction');
    }
    ...
    {
        $processor = new \XLite\Module\MultiSafepay\Connect\Model\Payment\Processor\Connect();
        $processor->gateway = 'Kelly';
        $processor->icon = 'msp_kelly.png';
