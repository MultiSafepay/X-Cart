...
namespace XLite\Module\MultiSafepay\Givacard\Model\Payment\Processor;

class Givacard extends \XLite\Model\Payment\Base\WebBased
{
    ...
    {
        return 'modules/MultiSafepay/Givacard/config.twig';
    }
    ...
    {
        $processor = new \XLite\Module\MultiSafepay\Connect\Model\Payment\Processor\Connect();
        $processor->startTransaction('', $transid, 'MultiSafepay Connect', 'GIVACARD');
    }
    ...
    {
        return \XLite\Core\Converter::buildURL('givacard', 'transaction');
    }
    ...
    {
        $processor = new \XLite\Module\MultiSafepay\Connect\Model\Payment\Processor\Connect();
        $processor->gateway = 'Givacard';
        $processor->icon = 'msp_givacard.png';
