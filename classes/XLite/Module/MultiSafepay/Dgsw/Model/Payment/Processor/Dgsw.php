...
namespace XLite\Module\MultiSafepay\Dgsw\Model\Payment\Processor;

class Dgsw extends \XLite\Model\Payment\Base\WebBased
{
    ...
    {
        return 'modules/MultiSafepay/Dgsw/config.twig';
    }
    ...
    {
        $processor = new \XLite\Module\MultiSafepay\Connect\Model\Payment\Processor\Connect();
        $processor->startTransaction('', $transid, 'MultiSafepay Connect', 'DEGROTESPEELGOEDWINKEL');
    }
    ...
    {
        return \XLite\Core\Converter::buildURL('degrotespeelgoedwinkel', 'transaction');
    }
    ...
    {
        $processor = new \XLite\Module\MultiSafepay\Connect\Model\Payment\Processor\Connect();
        $processor->gateway = 'Dgsw';
        $processor->icon = 'msp_degrotespeelgoedwinkel.png';
