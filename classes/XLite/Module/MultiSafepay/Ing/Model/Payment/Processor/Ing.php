...
namespace XLite\Module\MultiSafepay\Ing\Model\Payment\Processor;

class Ing extends \XLite\Model\Payment\Base\WebBased
{
    ...
    {
        return 'modules/MultiSafepay/Ing/config.twig';
    }
    ...
    {
        return \XLite\Core\Converter::buildURL('ing', 'transaction');
    }
