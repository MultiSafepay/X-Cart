...
namespace XLite\Module\MultiSafepay\Alipay\Model\Payment\Processor;

class Alipay extends \XLite\Model\Payment\Base\WebBased
{
    ...
    {
        return 'modules/MultiSafepay/Alipay/config.twig';
    }
    ...
    {
        $processor = new \XLite\Module\MultiSafepay\Connect\Model\Payment\Processor\Connect();
        $processor->startTransaction('', $transid, 'MultiSafepay Alipay', 'ALIPAY');
    }
    ...
    {
        return \XLite\Core\Converter::buildURL('alipay', 'transaction');
    }
    ...
    {
        $processor = new \XLite\Module\MultiSafepay\Connect\Model\Payment\Processor\Connect();
        $processor->gateway = 'Alipay';
        $processor->icon = 'msp_alipay.png';
