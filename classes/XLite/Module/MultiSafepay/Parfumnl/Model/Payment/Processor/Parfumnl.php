...
namespace XLite\Module\MultiSafepay\Parfumnl\Model\Payment\Processor;

class Parfumnl extends \XLite\Model\Payment\Base\WebBased
{
    ...
    {
        return 'modules/MultiSafepay/Parfumnl/config.twig';
    }
    ...
    {
        $processor = new \XLite\Module\MultiSafepay\Connect\Model\Payment\Processor\Connect();
        $processor->startTransaction('', $transid, 'MultiSafepay Connect', 'PARFUMNL');
    }
    ...
    {
        return \XLite\Core\Converter::buildURL('parfumnl', 'transaction');
    }
    ...
    {
        $processor = new \XLite\Module\MultiSafepay\Connect\Model\Payment\Processor\Connect();
        $processor->gateway = 'Parfumnl';
        $processor->icon = 'msp_parfumnl.png';
