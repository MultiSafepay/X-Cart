...
namespace XLite\Module\MultiSafepay\Goodcard\Model\Payment\Processor;

class Goodcard extends \XLite\Model\Payment\Base\WebBased
{
    ...
    {
        return 'modules/MultiSafepay/Goodcard/config.twig';
    }
    ...
    {
        $processor = new \XLite\Module\MultiSafepay\Connect\Model\Payment\Processor\Connect();
        $processor->startTransaction('', $transid, 'MultiSafepay Connect', 'GOODCARD');
    }
    ...
    {
        return \XLite\Core\Converter::buildURL('goodcard', 'transaction');
    }
    ...
    {
        $processor = new \XLite\Module\MultiSafepay\Connect\Model\Payment\Processor\Connect();
        $processor->gateway = 'Goodcard';
        $processor->icon = 'msp_goodcard.png';
