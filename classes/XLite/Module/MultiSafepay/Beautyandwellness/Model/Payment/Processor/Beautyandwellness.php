...
namespace XLite\Module\MultiSafepay\Beautyandwellness\Model\Payment\Processor;

class Beautyandwellness extends \XLite\Model\Payment\Base\WebBased
{
    ...
    {
        return 'modules/MultiSafepay/Beautyandwellness/config.twig';
    }
    ...
    {
        return \XLite\Core\Converter::buildURL('beautyandwellness', 'transaction');
    }
    ...
    {
        $processor = new \XLite\Module\MultiSafepay\Connect\Model\Payment\Processor\Connect();
        $processor->gateway = 'Beautyandwellness';
        $processor->icon = 'msp_beautyandwellness.png';
