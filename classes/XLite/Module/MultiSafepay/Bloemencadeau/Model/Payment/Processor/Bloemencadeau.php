...
namespace XLite\Module\MultiSafepay\Bloemencadeau\Model\Payment\Processor;

class Bloemencadeau extends \XLite\Model\Payment\Base\WebBased
{
    ...
    {
        return 'modules/MultiSafepay/Bloemencadeau/config.twig';
    }
    ...
    {
        return \XLite\Core\Converter::buildURL('bloemencadeau', 'transaction');
    }
    ...
    {
        $processor = new \XLite\Module\MultiSafepay\Connect\Model\Payment\Processor\Connect();
        $processor->gateway = 'Bloemencadeau';
        $processor->icon = 'msp_bloemencadeau.png';
