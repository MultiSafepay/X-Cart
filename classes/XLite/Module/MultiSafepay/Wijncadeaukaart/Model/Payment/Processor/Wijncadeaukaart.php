...
namespace XLite\Module\MultiSafepay\Wijncadeaukaart\Model\Payment\Processor;

class Wijncadeaukaart extends \XLite\Model\Payment\Base\WebBased
{
    ...
    {
        return 'modules/MultiSafepay/Wijncadeaukaart/config.twig';
    }
    ...
    {
        $processor = new \XLite\Module\MultiSafepay\Connect\Model\Payment\Processor\Connect();
        $processor->startTransaction('', $transid, 'MultiSafepay Connect', 'Wijncadeaukaart');
    }
    ...
    {
        return \XLite\Core\Converter::buildURL('Wijncadeaukaart', 'transaction');
    }
    ...
    {
        $processor = new \XLite\Module\MultiSafepay\Connect\Model\Payment\Processor\Connect();
        $processor->gateway = 'Wijncadeaukaart';
        $processor->icon = 'msp_wijncadeaukaart.png';
