...
namespace XLite\Module\MultiSafepay\Wellness\Model\Payment\Processor;

class Wellness extends \XLite\Model\Payment\Base\WebBased
{
    ...
    {
        return 'modules/MultiSafepay/Wellness/config.twig';
    }
    ...
    {
        $processor = new \XLite\Module\MultiSafepay\Connect\Model\Payment\Processor\Connect();
        $processor->startTransaction('', $transid, 'MultiSafepay Connect', 'WELLNESSGIFTCARD');
    }
    ...
    {
        return \XLite\Core\Converter::buildURL('Wellness', 'transaction');
    }
    ...
    {
        $processor = new \XLite\Module\MultiSafepay\Connect\Model\Payment\Processor\Connect();
        $processor->gateway = 'Wellness';
        $processor->icon = 'msp_wellness.png';
