...
namespace XLite\Module\MultiSafepay\Trustly\Model\Payment\Processor;

class Trustly extends \XLite\Model\Payment\Base\WebBased
{
    ...
    {
        return 'modules/MultiSafepay/Trustly/config.twig';
    }
    ...
    {
        $processor = new \XLite\Module\MultiSafepay\Connect\Model\Payment\Processor\Connect();
        $processor->startTransaction('', $transid, 'MultiSafepay Trustly', 'TRUSTLY');
    }
    ...
    {
        return \XLite\Core\Converter::buildURL('trustly', 'transaction');
    }
    ...
    {
        $processor = new \XLite\Module\MultiSafepay\Connect\Model\Payment\Processor\Connect();
        $processor->gateway = 'Trustly';
        $processor->icon = 'msp_trustly.png';
