...
class Kbc extends \XLite\Model\Payment\Base\WebBased
{
    ...
    {
        $processor = new \XLite\Module\MultiSafepay\Connect\Model\Payment\Processor\Connect();
        $processor->startTransaction('', $transid, 'MultiSafepay KBC', 'KBC');
    }
    ...
    {
        return \XLite\Core\Converter::buildURL('kbc', 'transaction');
    }
