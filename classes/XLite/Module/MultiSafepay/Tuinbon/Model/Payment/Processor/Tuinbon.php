...
namespace XLite\Module\MultiSafepay\Tuinbon\Model\Payment\Processor;

class Tuinbon extends \XLite\Model\Payment\Base\WebBased
{
    ...
    {
        return 'modules/MultiSafepay/Tuinbon/config.twig';
    }
    ...
    {
        $processor = new \XLite\Module\MultiSafepay\Connect\Model\Payment\Processor\Connect();
        $processor->startTransaction('', $transid, 'MultiSafepay Connect', 'TUINBON');
    }
    ...
    {
        return \XLite\Core\Converter::buildURL('TUINBON', 'transaction');
    }
    ...
    {
        $processor = new \XLite\Module\MultiSafepay\Connect\Model\Payment\Processor\Connect();
        $processor->gateway = 'Tuinbon';
        $processor->icon = 'msp_tuinbon.png';
