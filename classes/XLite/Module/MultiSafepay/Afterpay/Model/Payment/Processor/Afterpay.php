...
class Afterpay extends \XLite\Model\Payment\Base\WebBased
{
    ...
    {
        $processor = new \XLite\Module\MultiSafepay\Connect\Model\Payment\Processor\Connect();
        $processor->startTransaction('', $transid, 'MultiSafepay Afterpay', 'AFTERPAY', $this->getSetting('mode'));
    }
    ...
    {
        return \XLite\Core\Converter::buildURL('afterpay', 'transaction');
    }
