...
namespace XLite\Module\MultiSafepay\Bancontact\Model\Payment\Processor;
...
class Bancontact extends \XLite\Model\Payment\Base\WebBased
{
    ...
    {
        return 'modules/MultiSafepay/Bancontact/config.twig';
    }
    ...
    {
        $processor = new \XLite\Module\MultiSafepay\Connect\Model\Payment\Processor\Connect();
        $processor->startTransaction('', $transid, 'MultiSafepay Bancontact', 'MISTERCASH');
    }
    ...
    {
        return \XLite\Core\Converter::buildURL('bancontact', 'transaction');
    }
    ...
    {
        $processor = new \XLite\Module\MultiSafepay\Connect\Model\Payment\Processor\Connect();
        $processor->gateway = 'Bancontact';
        $processor->icon = 'msp_bancontact.png';
