...
namespace XLite\Module\MultiSafepay\Lief\Model\Payment\Processor;

class Lief extends \XLite\Model\Payment\Base\WebBased
{
    ...
    {
        return 'modules/MultiSafepay/Lief/config.twig';
    }
    ...
    {
        $processor = new \XLite\Module\MultiSafepay\Connect\Model\Payment\Processor\Connect();
        $processor->startTransaction('', $transid, 'MultiSafepay Connect', 'LIEF');
    }
    ...
    {
        return \XLite\Core\Converter::buildURL('lief', 'transaction');
    }
    ...
    {
        $processor = new \XLite\Module\MultiSafepay\Connect\Model\Payment\Processor\Connect();
        $processor->gateway = 'Lief';
        $processor->icon = 'msp_lief.png';
