...
namespace XLite\Module\MultiSafepay\Ferbuy\Model\Payment\Processor;

class Ferbuy extends \XLite\Model\Payment\Base\WebBased
{
    ...
    {
        return 'modules/MultiSafepay/Ferbuy/config.twig';
    }
    ...
    {
        $processor = new \XLite\Module\MultiSafepay\Connect\Model\Payment\Processor\Connect();
        $processor->startTransaction('', $transid, 'MultiSafepay Connect', 'FERBUY');
    }
    ...
    {
        return \XLite\Core\Converter::buildURL('ferbuy', 'transaction');
    }
    ...
    {
        $processor = new \XLite\Module\MultiSafepay\Connect\Model\Payment\Processor\Connect();
        $processor->gateway = 'Ferbuy';
        $processor->icon = 'msp_ferbuy.png';
