...
namespace XLite\Module\MultiSafepay\Wsg\Model\Payment\Processor;

class Wsg extends \XLite\Model\Payment\Base\WebBased
{
    ...
    {
        return 'modules/MultiSafepay/Wsg/config.twig';
    }
    ...
    {
        $processor = new \XLite\Module\MultiSafepay\Connect\Model\Payment\Processor\Connect();
        $processor->startTransaction('', $transid, 'MultiSafepay Connect', 'WEBSHOPGIFTCARD');
    }
    ...
    {
        return \XLite\Core\Converter::buildURL('Wsg', 'transaction');
    }
    ...
    {
        $processor = new \XLite\Module\MultiSafepay\Connect\Model\Payment\Processor\Connect();
        $processor->gateway = 'Wsg';
        $processor->icon = 'msp_wsg.png';
