...
namespace XLite\Module\MultiSafepay\Parfumcadeaukaart\Model\Payment\Processor;

class Parfumcadeaukaart extends \XLite\Model\Payment\Base\WebBased
{
    ...
    {
        return 'modules/MultiSafepay/Parfumcadeaukaart/config.twig';
    }
    ...
    {
        $processor = new \XLite\Module\MultiSafepay\Connect\Model\Payment\Processor\Connect();
        $processor->startTransaction('', $transid, 'MultiSafepay Connect', 'PARFUMCADEAUKAART');
    }
    ...
    {
        return \XLite\Core\Converter::buildURL('parfumcadeaukaart', 'transaction');
    }
    ...
    {
        $processor = new \XLite\Module\MultiSafepay\Connect\Model\Payment\Processor\Connect();
        $processor->gateway = 'Parfumcadeaukaart';
