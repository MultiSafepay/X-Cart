...
namespace XLite\Module\MultiSafepay\Podium\Model\Payment\Processor;

class Podium extends \XLite\Model\Payment\Base\WebBased
{
    ...
    {
        return 'modules/MultiSafepay/Podium/config.twig';
    }
    ...
    {
        $processor = new \XLite\Module\MultiSafepay\Connect\Model\Payment\Processor\Connect();
        $processor->startTransaction('', $transid, 'MultiSafepay Connect', 'PODIUM');
    }
    ...
    {
        return \XLite\Core\Converter::buildURL('Podium', 'transaction');
    }
    ...
    {
        $processor = new \XLite\Module\MultiSafepay\Connect\Model\Payment\Processor\Connect();
        $processor->gateway = 'Podium';
        $processor->icon = 'msp_podium.png';
