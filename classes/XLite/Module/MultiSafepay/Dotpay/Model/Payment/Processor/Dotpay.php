...
namespace XLite\Module\MultiSafepay\Dotpay\Model\Payment\Processor;

class Dotpay extends \XLite\Model\Payment\Base\WebBased
{
    ...
    {
        return 'modules/MultiSafepay/Dotpay/config.twig';
    }
    ...
    public function processReturn(\XLite\Model\Payment\Transaction $transaction)
    {
        ...
        $processor->settings = 'MultiSafepay Dotpay';
    ...
    {
        $processor = new \XLite\Module\MultiSafepay\Connect\Model\Payment\Processor\Connect();
        $processor->startTransaction('', $transid, 'MultiSafepay Connect', 'DOTPAY');
    }
    ...
    {
        return \XLite\Core\Converter::buildURL('dotpay', 'transaction');
    }
    ...
    {
        $processor = new \XLite\Module\MultiSafepay\Connect\Model\Payment\Processor\Connect();
        $processor->gateway = 'Dotpay';
        $processor->icon = 'msp_dotpay.png';
