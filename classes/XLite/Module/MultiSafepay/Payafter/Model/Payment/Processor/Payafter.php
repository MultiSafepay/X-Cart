...
class Payafter extends \XLite\Model\Payment\Base\WebBased
{
    ...
    public $icon = 'msp_payafter.png';
    public $gateway = 'Payafter';
    ...
    {
        return 'modules/MultiSafepay/Payafter/config.twig';
    }
     ...
     * @param type $gateway
     */
    public function startPayAfter($transid, $settings = 'MultiSafepay Connect', $gateway = "PAYAFTER")
    {
    ...
    {
        if ($this->getSetting('transaction_type') == '1') {
            return 'modules/MultiSafepay/Payafter/checkout/payafter.twig';
        }
    }
