...
class Santander extends \XLite\Model\Payment\Base\WebBased
{
    ...
    {
        $processor = new \XLite\Module\MultiSafepay\Connect\Model\Payment\Processor\Connect();
        $processor->startTransaction('', $transid, 'MultiSafepay Santander Betaalplan', 'SANTANDER');
    }
    ...
    {
        return \XLite\Core\Converter::buildURL('santander', 'transaction');
    }
