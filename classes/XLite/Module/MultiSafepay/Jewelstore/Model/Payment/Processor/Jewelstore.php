...
namespace XLite\Module\MultiSafepay\Jewelstore\Model\Payment\Processor;

class Jewelstore extends \XLite\Model\Payment\Base\WebBased
{
    ...
    {
        return 'modules/MultiSafepay/Jewelstore/config.twig';
    }
    ...
    {
        $processor = new \XLite\Module\MultiSafepay\Connect\Model\Payment\Processor\Connect();
        $processor->startTransaction('', $transid, 'MultiSafepay Connect', 'JEWELSTORE');
    }
    ...
    {
        return \XLite\Core\Converter::buildURL('jewelstore', 'transaction');
    }
    ...
    {
        $processor = new \XLite\Module\MultiSafepay\Connect\Model\Payment\Processor\Connect();
        $processor->gateway = 'Jewelstore';
        $processor->icon = 'msp_jewelstore.png';
