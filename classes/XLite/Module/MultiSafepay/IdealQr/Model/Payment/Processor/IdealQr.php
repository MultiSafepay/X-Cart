...
class IdealQr extends \XLite\Model\Payment\Base\WebBased
{
    ...
    {
        $processor = new \XLite\Module\MultiSafepay\Connect\Model\Payment\Processor\Connect();
        $processor->startTransaction('', $transid, 'MultiSafepay iDEAL QR', 'IDEALQR');
    }
    ...
    {
        return \XLite\Core\Converter::buildURL('idealqr', 'transaction');
    }
