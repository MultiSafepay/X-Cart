...
namespace XLite\Module\MultiSafepay\Belfius\Model\Payment\Processor;

class Belfius extends \XLite\Model\Payment\Base\WebBased
{
    ...
    {
        return array(\XLite\Model\Payment\BackendTransaction::TRAN_TYPE_REFUND);
    }
    ...
    {
        return 'modules/MultiSafepay/Belfius/config.twig';
    }
    ...
    {
        $processor = new \XLite\Module\MultiSafepay\Connect\Model\Payment\Processor\Connect();
        $processor->startTransaction('', $transid, 'MultiSafepay Belfius', 'BELFIUS');
    }
    ...
    {
        return \XLite\Core\Converter::buildURL('belfius', 'transaction');
    }
    ...
    {
        $processor = new \XLite\Module\MultiSafepay\Connect\Model\Payment\Processor\Connect();
        $processor->gateway = 'Belfius';
        $processor->icon = 'msp_belfius.png';
