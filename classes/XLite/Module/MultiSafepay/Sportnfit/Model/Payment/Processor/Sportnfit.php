...
namespace XLite\Module\MultiSafepay\Sportnfit\Model\Payment\Processor;

class Sportnfit extends \XLite\Model\Payment\Base\WebBased
{
    ...
    {
        return 'modules/MultiSafepay/Sportnfit/config.twig';
    }
    ...
    {
        $processor = new \XLite\Module\MultiSafepay\Connect\Model\Payment\Processor\Connect();
        $processor->startTransaction('', $transid, 'MultiSafepay Connect', 'SPORTENFIT');
    }
    ...
    {
        return \XLite\Core\Converter::buildURL('sportnfit', 'transaction');
    }
    ...
    {
        $processor = new \XLite\Module\MultiSafepay\Connect\Model\Payment\Processor\Connect();
        $processor->gateway = 'Sportnfit';
        $processor->icon = 'msp_sportnfit.png';
