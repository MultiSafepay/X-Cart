...
namespace XLite\Module\MultiSafepay\Giropay\Model\Payment\Processor;

class Giropay extends \XLite\Model\Payment\Base\WebBased
{
    ...
    {
        return 'modules/MultiSafepay/Giropay/config.twig';
    }
    ...
    {
        $processor = new \XLite\Module\MultiSafepay\Connect\Model\Payment\Processor\Connect();
        $processor->startTransaction('', $transid, 'MultiSafepay Connect', 'GIROPAY');
    }
    ...
    {
        return \XLite\Core\Converter::buildURL('giropay', 'transaction');
    }
