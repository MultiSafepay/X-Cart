...
namespace XLite\Module\MultiSafepay\Vvv\Model\Payment\Processor;

class Vvv extends \XLite\Model\Payment\Base\WebBased
{
    ...
    {
        return 'modules/MultiSafepay/Vvv/config.twig';
    }
    ...
    {
        $processor = new \XLite\Module\MultiSafepay\Connect\Model\Payment\Processor\Connect();
        $processor->startTransaction('', $transid, 'MultiSafepay Connect', 'VVVBON');
    }
    ...
    {
        return \XLite\Core\Converter::buildURL('vvv', 'transaction');
    }
    ...
    {
        $processor = new \XLite\Module\MultiSafepay\Connect\Model\Payment\Processor\Connect();
        $processor->gateway = 'Vvv';
        $processor->icon = 'msp_vvvgiftcard.png';
