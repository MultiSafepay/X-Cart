...
namespace XLite\Module\MultiSafepay\Brouwmarkt\Model\Payment\Processor;

class Brouwmarkt extends \XLite\Model\Payment\Base\WebBased
{
    ...
    {
        return 'modules/MultiSafepay/Brouwmarkt/config.twig';
    }
    ...
    {
        $processor = new \XLite\Module\MultiSafepay\Connect\Model\Payment\Processor\Connect();
        $processor->startTransaction('', $transid, 'MultiSafepay Connect', 'BROUWMARKT');
    }
    ...
    {
        return \XLite\Core\Converter::buildURL('brouwmarkt', 'transaction');
    }
    ...
    {
        $processor = new \XLite\Module\MultiSafepay\Connect\Model\Payment\Processor\Connect();
        $processor->gateway = 'Brouwmarkt';
        $processor->icon = 'msp_brouwmarkt.png';
